...
namespace System.Diagnostics.Contracts {
    ...
    public sealed class ContractClassAttribute : Attribute {
        ...
        public ContractClassAttribute(Type typeContainingContracts) => this._typeWithContracts = typeContainingContracts;

        public Type TypeContainingContracts => this._typeWithContracts;
    }
    ...
    public sealed class ContractClassForAttribute : Attribute {
        ...
        public ContractClassForAttribute(Type typeContractsAreFor) => this._typeIAmAContractFor = typeContractsAreFor;

        public Type TypeContractsAreFor => this._typeIAmAContractFor;
    }
    ...
    */
    ...
    public sealed class ContractVerificationAttribute : Attribute {
        ...
        public ContractVerificationAttribute(bool value) => this._value = value;
    ...
    public sealed class ContractPublicPropertyNameAttribute : Attribute {
        ...
        public ContractPublicPropertyNameAttribute(string name) => this._publicName = name;

        public string Name => this._publicName;
    }
    ...
    public sealed class ContractOptionAttribute : Attribute {
        ...
        public string Setting => this._setting;
    ...
    public static partial class Contract {
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
#endif
        public static void Requires(bool condition) => AssertMustUseRewriter(ContractFailureKind.Precondition, "Requires");
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
#endif
        public static void Requires<TException>(bool condition) where TException : Exception => AssertMustUseRewriter(ContractFailureKind.Precondition, "Requires<TException>");
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
#endif
        public static void EnsuresOnThrow<TException>(bool condition) where TException : Exception => AssertMustUseRewriter(ContractFailureKind.PostconditionOnException, "EnsuresOnThrow");
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
#endif
        public static void Invariant(bool condition) => AssertMustUseRewriter(ContractFailureKind.Invariant, "Invariant");
...
namespace System.Diagnostics.Contracts.Internal {
    ...
    public static class ContractHelper {
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
#endif
        public static string RaiseContractFailedEvent(ContractFailureKind failureKind, string userMessage, string conditionText, Exception innerException) => System.Runtime.CompilerServices.ContractHelper.RaiseContractFailedEvent(failureKind, userMessage, conditionText, innerException);
