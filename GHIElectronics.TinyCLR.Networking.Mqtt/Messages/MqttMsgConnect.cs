...
namespace GHIElectronics.TinyCLR.Networking.Mqtt {
    ...
    public class MqttMsgConnect : MqttMsgBase {
        ...
        public override byte[] GetBytes(byte protocolVersion) {
            ...
            if ((this.willQosLevel < QOS_LEVEL_AT_MOST_ONCE) ||
                (this.willQosLevel > QOS_LEVEL_EXACTLY_ONCE))
                throw new MqttClientException(MqttClientErrorCode.WillWrong);
