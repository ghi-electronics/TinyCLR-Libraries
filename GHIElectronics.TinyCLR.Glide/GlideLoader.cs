...
namespace GHIElectronics.TinyCLR.Glide
{
    ...
    public static class GlideLoader
    {
        ...
        static TextAlignment FromAlignment(uint Alignment)
        {
            ...
            switch (Alignment)
            {
                case GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentCenter:
                    format = TextAlignment.Center; 
                    break;
                case GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentLeft:
                    format = TextAlignment.Left;
                    break;
                case GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentRight:
