        ...
        public static class Convert
        {
            ...
            */
            ...
            public static uint ToAlignment(string alignment)
            {
                ...
                {
                    case "LEFT":
                        return GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentLeft;
                    case "CENTER":
                        return GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentCenter;
                    case "RIGHT":
                        return GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentRight;
                    default:
                        return GHIElectronics.TinyCLR.Glide.BitmapHelper.DT_AlignmentRight;
                }
            }
