...
namespace GHIElectronics.TinyCLR.Update {
    public static class FileUpdater {
        ...
        public static void LoadAndFlashDeployment(FileStream stream, uint checksum, byte[] key) {
        ...
        private static extern void NativeLoadAndFlashDeployment(FileStream stream, byte[] key, uint checksum);
    }
}
