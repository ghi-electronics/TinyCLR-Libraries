namespace GHIElectronics.TinyCLR.Pins {
    ...
    public static class G120 {
        ...
        public static class I2cBus {
            ...
            public const string I2c1 = "GHIElectronics.TinyCLR.NativeApis.LPC178.I2cProvider\\0";
        }

        /// <summary>SPI bus definitions.</summary>
        public static class SpiBus {
            /// <summary>SPI bus on P0.18 (MOSI), P0.17 (MISO), and P0.15 (SCK).</summary>
            public const string Spi1 = "GHIElectronics.TinyCLR.NativeApis.LPC178.SpiProvider\\0";
            /// <summary>SPI bus.</summary>
            public const string Spi2 = "GHIElectronics.TinyCLR.NativeApis.LPC178.SpiProvider\\1";
            /// <summary>SPI bus on P1.1 (MOSI), P1.4 (MISO), and P1.0 (SCK).</summary>
            public const string Spi3 = "GHIElectronics.TinyCLR.NativeApis.LPC178.SpiProvider\\2";
        }
