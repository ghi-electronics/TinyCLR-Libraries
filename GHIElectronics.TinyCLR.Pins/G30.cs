namespace GHIElectronics.TinyCLR.Pins {
    ...
    public static class G30 {
        ...
        public static class GpioPin {
            public const string Id = "GHIElectronics.TinyCLR.NativeApis.G30.GpioProvider\\0";
        ...
        public static class AdcChannel {
            public const string Id = "GHIElectronics.TinyCLR.NativeApis.G30.AdcProvider\\0";
        ...
        public static class PwmPin {
            ...
            public static class Controller1 {
                public const string Id = "GHIElectronics.TinyCLR.NativeApis.G30.PwmProvider\\0";
            ...
            public static class Controller2 {
                public const string Id = "GHIElectronics.TinyCLR.NativeApis.G30.PwmProvider\\1";
            ...
            public static class Controller3 {
                public const string Id = "GHIElectronics.TinyCLR.NativeApis.G30.PwmProvider\\2";
            ...
            public static class Controller4 {
                public const string Id = "GHIElectronics.TinyCLR.NativeApis.G30.PwmProvider\\3";
        ...
        public static class SerialPort {
            ...
            public const string Com1 = "GHIElectronics.TinyCLR.NativeApis.G30.UartProvider\\0";
            /// <summary>Serial port on PA2 (TX), PA3 (RX), PA0 (CTS), and PA1 (RTS).</summary>
            public const string Com2 = "GHIElectronics.TinyCLR.NativeApis.G30.UartProvider\\1";
        }

        /// <summary>I2C bus definitions.</summary>
        public static class I2cBus {
            /// <summary>I2C bus on PB7 (SDA) and PB6 (SCL).</summary>
            public const string I2c1 = "GHIElectronics.TinyCLR.NativeApis.G30.I2cProvider\\0";
        }

        /// <summary>SPI bus definitions.</summary>
        public static class SpiBus {
            /// <summary>SPI bus on PB5 (MOSI), PB4 (MISO), and PB3 (SCK).</summary>
            public const string Spi1 = "GHIElectronics.TinyCLR.NativeApis.G30.SpiProvider\\0";
            /// <summary>SPI bus on PB15 (MOSI), PB14 (MISO), and PB13 (SCK).</summary>
            public const string Spi2 = "GHIElectronics.TinyCLR.NativeApis.G30.SpiProvider\\1";
        }
    }
}