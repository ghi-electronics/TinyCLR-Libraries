...
#pragma warning restore 0169
		...
		public Keyboard(uint id, byte interfaceIndex, ushort vendorId, ushort productId, byte portNumber)
			: base(id, interfaceIndex, DeviceType.Keyboard, vendorId, productId, portNumber) {
