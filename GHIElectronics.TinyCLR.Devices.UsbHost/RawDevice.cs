...
#pragma warning restore 0169
		...
		public RawDevice(uint id, byte interfaceIndex, ushort vendorId, ushort productId, byte portNumber, DeviceType deviceType)
			: base(id, interfaceIndex, deviceType, vendorId, productId, portNumber) {
