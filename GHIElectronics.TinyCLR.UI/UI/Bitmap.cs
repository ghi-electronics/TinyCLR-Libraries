...
namespace GHIElectronics.TinyCLR.UI {
    internal class Bitmap : IDisposable {
        ...
        public Bitmap(System.Drawing.Graphics g) => this.g = g;
        ...
        internal void SetPixel(int x, int y, Color color) => this.g.surface.SetPixel(x, y, (uint)color.ToNativeColor());
        internal void SetClippingRectangle(int x, int y, int width, int height) => this.g.surface.SetClippingRectangle(x, y, width, height);

        internal void DrawEllipse(Color color1, ushort thickness, int v1, int v2, int xRadius, int yRadius, Color color2, int v3, int v4, Color color3, int v5, int v6, ushort v7) => this.g.surface.DrawEllipse((uint)color1.ToNativeColor(), thickness, v1, v2, xRadius, yRadius, (uint)color2.ToNativeColor(), v3, v4, (uint)color3.ToNativeColor(), v5, v6, v7);
        internal void DrawRectangle(Color outlineColor, ushort outlineThickness, int x, int y, int width, int height, int v1, int v2, Color color1, int v3, int v4, Color color2, int v5, int v6, ushort opacity) => this.g.surface.DrawRectangle((uint)outlineColor.ToNativeColor(), outlineThickness, x, y, width, height, v1, v2, (uint)color1.ToNativeColor(), v3, v4, (uint)color2.ToNativeColor(), v5, v6, opacity);
        ...
        internal void DrawLine(Color color, int v, int ix1, int y1, int ix2, int y2) => this.g.surface.DrawLine((uint)color.ToNativeColor(), v, ix1, y1, ix2, y2);
        internal void DrawText(string text, System.Drawing.Font font, Color color, int v1, int v2) => this.g.surface.DrawText(text, font, (uint)color.ToNativeColor(), v1, v2);
        internal bool DrawTextInRect(ref string text, ref int xRelStart, ref int yRelStart, int v1, int v2, int width, int height, uint flags, Color color, System.Drawing.Font font) => this.g.surface.DrawTextInRect(ref text, ref xRelStart, ref yRelStart, v1, v2, width, height, flags, (uint)color.ToNativeColor(), font);
