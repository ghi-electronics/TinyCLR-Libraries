...
namespace System.Xml
{
    ...
    internal class XmlNamespaces
    {
        ...
        public XmlNamespaces() => this.m_namespaceList = new ArrayList();
        ...
        public XmlNamespace this[string prefix]
        {
            ...
            {
                XmlNamespace ns;
                var count = this.m_namespaceList.Count;
                for (var i = 0; i < count; i++)
                {
                    ns = (XmlNamespace)this.m_namespaceList[i];
                    if (ns.Prefix == prefix)
                    {
                        return ns;
                    }
        ...
        public int Add(string prefix, string namespaceURI)
        {
            if (this.NewNamespaceExists(prefix, namespaceURI))
                return -1;
            return this.m_namespaceList.Add(new XmlNamespace(prefix, namespaceURI));
        }
