...
namespace System.Xml
{
    ...
    internal class ValidateNames
    {
        ...
        public static int ParseNCName(string s, int offset)
        {
            ...
            var xmlCharType = XmlCharType.Instance;
        ...
        {
            var len = ParseQName(s, 0, out var colonOffset);
        ...
        // </summary>
        private static string CreateName(string prefix, string localName) => (prefix.Length != 0) ? prefix + ":" + localName : localName;
    }
}
