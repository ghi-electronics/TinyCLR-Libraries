...
namespace GHIElectronics.TinyCLR.BrainPad {
    public class LightBulb {
        ...
        public LightBulb() {
            ...
            var PWM = PwmController.FromId(Board.BoardType == BoardType.BP1 ? FEZChip.PwmPin.Controller3.Id : G30.PwmPin.Controller3.Id);
            PWM.SetDesiredFrequency(10000);
            this.red = PWM.OpenPin(Board.BoardType == BoardType.BP1 ? FEZChip.PwmPin.Controller3.PC9 : G30.PwmPin.Controller3.PC9);
            this.green = PWM.OpenPin(Board.BoardType == BoardType.BP1 ? FEZChip.PwmPin.Controller3.PC8 : G30.PwmPin.Controller3.PC8);
            this.blue = PWM.OpenPin(Board.BoardType == BoardType.BP1 ? FEZChip.PwmPin.Controller3.PC6 : G30.PwmPin.Controller3.PC7);
