...
namespace GHIElectronics.TinyCLR.BrainPad.Internal {
    ...
    public class ImageBuffer {
        ...
        public void DrawPoint(int x, int y, Color color = Color.Blue) {
            if (x < 0 || x > 127)
                return;
            if (y < 0 || y > 63)
                return;
        ...
        /// <param name="color">The color to draw.</param>
        public void DrawLine(int x0, int y0, int x1, int y1, Color color = Color.Blue) {
        ...
        /// <param name="color">The color to draw.</param>
        public void DrawCircle(int x, int y, int r, Color color = Color.Blue) {
        ...
        public void DrawRectangle(int x, int y, int width, int height, Color color = Color.Blue) {
            if (width < 0) return;
            if (height < 0) return;
        ...
        private void DrawText(int x, int y, char letter, int HScale, int VScale, Color color) {
        ...
        /// <param name="y">The y coordinate to draw at.</param>
        /// <param name="text">The string to draw.</param>
        public void DrawText(int x, int y, string text, int HScale, int VScale, Color color = Color.Blue) {
            var originalX = x;
