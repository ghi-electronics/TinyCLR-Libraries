        ...
        public class Servo {
            ...
            internal Servo(int servo) {
                switch (Board.BoardType) {
                    case BoardType.BP2:
                        this.controller = PwmController.FromId(FEZFirmware.PwmPin.Controller2.Id);
                ...
                switch (Board.BoardType) {
                    case BoardType.BP2:
                        this.servo = this.controller.OpenPin(servo == 0 ? FEZFirmware.PwmPin.Controller2.PA3 : FEZFirmware.PwmPin.Controller2.PA0);
