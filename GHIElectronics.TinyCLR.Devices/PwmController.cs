...
namespace GHIElectronics.TinyCLR.Devices.Pwm {
    public sealed class PwmController {
        ...
        public static PwmController GetDefault() => LowLevelDevicesController.DefaultProvider?.PwmControllerProvider != null ? new PwmController(LowLevelDevicesController.DefaultProvider?.PwmControllerProvider) : PwmController.FromId(Api.GetDefaultName(ApiType.PwmProvider));
