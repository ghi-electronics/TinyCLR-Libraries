...
namespace GHIElectronics.TinyCLR.Devices.Adc {
    public sealed class AdcController {
        ...
        public static AdcController GetDefault() => new AdcController(LowLevelDevicesController.DefaultProvider?.AdcControllerProvider ?? AdcProvider.FromId(DefaultDeviceNames.AdcProvider).GetControllers()[0]);
