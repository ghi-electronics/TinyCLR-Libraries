...
namespace GHIElectronics.TinyCLR.Devices.I2c {
    public class I2cSoftwareProvider : II2cProvider {
        ...
        private class I2cSoftwareControllerProvider : II2cControllerProvider {
            ...
            public II2cDeviceProvider GetDeviceProvider(ProviderI2cConnectionSettings settings) => object.ReferenceEquals(this.controller, GpioController.GetDefault()) ? (II2cDeviceProvider)new I2cNativeSoftwareDeviceProvider(settings, this.sda, this.scl, this.useSoftwarePullups) : new I2cManagedSoftwareDeviceProvider(settings, this.controller.OpenPin(this.sda), this.controller.OpenPin(this.scl), this.useSoftwarePullups);
        }
