...
namespace GHIElectronics.TinyCLR.Devices.I2c {
    public sealed class I2cController {
        ...
        public static I2cController GetDefault() => new I2cController(LowLevelDevicesController.DefaultProvider?.I2cControllerProvider ?? (Api.ParseSelector(Api.GetDefaultName(ApiType.I2cProvider), out var providerId, out var idx) ? I2cProvider.FromId(providerId).GetControllers()[idx] : null));
