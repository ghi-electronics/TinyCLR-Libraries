...
namespace GHIElectronics.TinyCLR.Devices.Dac {
    public sealed class DacController {
        ...
        public static DacController GetDefault() => new DacController(LowLevelDevicesController.DefaultProvider?.DacControllerProvider ?? DacProvider.FromId("DefaultDacProvider").GetControllers()[0]);
